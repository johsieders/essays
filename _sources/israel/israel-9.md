...
*Quellen und Vertiefung:* {cite}`khalidi2020`; {cite}`morris2004` (zur Frage geplant vs. Chaos); {cite}`masalha1992`; {cite}`shlaim2000` und {cite}`shlaim2007`; als Gegenstimmen der „New Historians“: {cite}`karsh2010` und {cite}`gelber2006`; {cite}`kepel2000` und {cite}`filiu2014` (zur Entstehung islamistischer Bewegungen); {cite}`norton2007`; {cite}`horne1977` (Algerien).