...
- Die Provinz **Judäa** wurde in **Syria Palaestina** umbenannt – nach den Philistern (→ {ref}`Abschnitt 1 <sec-1-1>`), den biblischen Erzfeinden Israels, die als Volk längst von der historischen Bühne verschwunden waren. Die Wahl dieses Namens war ein bewusster Akt der symbolischen Auslöschung.
