...
*Quellen und Vertiefung:* {cite}`segev1986`; {cite}`shapira2012`; {cite}`morris2008`; {cite}`shohat1988` (Mizrachim und aschkenasische Dominanz); {cite}`shenhav2006`; {cite}`lustick1980`; {cite}`shlaim2000`; {cite}`benzvi1998`; {cite}`rejwan1998`.